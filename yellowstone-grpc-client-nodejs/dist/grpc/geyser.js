...
exports.SubscribeRequest = {
    ...
    fromJSON: function (object) {
        return {
            ...
            accountsDataSlice: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.accountsDataSlice)
                ? object.accountsDataSlice.map(function (e) {
                    return exports.SubscribeRequestAccountsDataSlice.fromJSON(e);
                })
                : [],
            ping: isSet(object.ping)
                ? exports.SubscribeRequestPing.fromJSON(object.ping)
                : undefined
        };
    },
    toJSON: function (message) {
        ...
        if (message.slots) {
            var entries = Object.entries(message.slots);
            if (entries.length > 0) {
                obj.slots = {};
                entries.forEach(function (_a) {
                    var k = _a[0], v = _a[1];
        ...
        if (message.blocks) {
            var entries = Object.entries(message.blocks);
            if (entries.length > 0) {
                obj.blocks = {};
                entries.forEach(function (_a) {
                    var k = _a[0], v = _a[1];
        ...
        if (message.entry) {
            var entries = Object.entries(message.entry);
            if (entries.length > 0) {
                obj.entry = {};
                entries.forEach(function (_a) {
                    var k = _a[0], v = _a[1];
        ...
        if ((_a = message.accountsDataSlice) === null || _a === void 0 ? void 0 : _a.length) {
            obj.accountsDataSlice = message.accountsDataSlice.map(function (e) {
                return exports.SubscribeRequestAccountsDataSlice.toJSON(e);
            });
        }
        if (message.ping !== undefined) {
    ...
    fromPartial: function (object) {
        ...
        message.accountsDataSlice =
            ((_h = object.accountsDataSlice) === null || _h === void 0 ? void 0 : _h.map(function (e) {
                return exports.SubscribeRequestAccountsDataSlice.fromPartial(e);
            })) || [];
        message.ping =
    ...
    fromJSON: function (object) {
        return {
            ...
            value: isSet(object.value)
                ? exports.SubscribeRequestFilterAccounts.fromJSON(object.value)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeRequest_SlotsEntry = {
    ...
    fromJSON: function (object) {
        return {
            key: isSet(object.key) ? globalThis.String(object.key) : "",
            value: isSet(object.value)
                ? exports.SubscribeRequestFilterSlots.fromJSON(object.value)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeRequest_TransactionsEntry = {
    ...
    fromJSON: function (object) {
        return {
            key: isSet(object.key) ? globalThis.String(object.key) : "",
            value: isSet(object.value)
                ? exports.SubscribeRequestFilterTransactions.fromJSON(object.value)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeRequest_BlocksEntry = {
    ...
    fromJSON: function (object) {
        return {
            key: isSet(object.key) ? globalThis.String(object.key) : "",
            value: isSet(object.value)
                ? exports.SubscribeRequestFilterBlocks.fromJSON(object.value)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeRequest_BlocksMetaEntry = {
    ...
    fromJSON: function (object) {
        return {
            key: isSet(object.key) ? globalThis.String(object.key) : "",
            value: isSet(object.value)
                ? exports.SubscribeRequestFilterBlocksMeta.fromJSON(object.value)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeRequest_EntryEntry = {
    ...
    fromJSON: function (object) {
        return {
            key: isSet(object.key) ? globalThis.String(object.key) : "",
            value: isSet(object.value)
                ? exports.SubscribeRequestFilterEntry.fromJSON(object.value)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeRequestFilterAccounts = {
    ...
    fromJSON: function (object) {
        return {
            account: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.account)
                ? object.account.map(function (e) { return globalThis.String(e); })
                : [],
            owner: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.owner)
                ? object.owner.map(function (e) { return globalThis.String(e); })
                : [],
            filters: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.filters)
                ? object.filters.map(function (e) {
                    return exports.SubscribeRequestFilterAccountsFilter.fromJSON(e);
                })
                : []
        };
    },
    toJSON: function (message) {
        ...
        if ((_c = message.filters) === null || _c === void 0 ? void 0 : _c.length) {
            obj.filters = message.filters.map(function (e) {
                return exports.SubscribeRequestFilterAccountsFilter.toJSON(e);
            });
        }
        return obj;
    },
    ...
    fromPartial: function (object) {
        ...
        message.filters =
            ((_c = object.filters) === null || _c === void 0 ? void 0 : _c.map(function (e) {
                return exports.SubscribeRequestFilterAccountsFilter.fromPartial(e);
            })) || [];
        return message;
    }
};
    ...
    fromJSON: function (object) {
        return {
            memcmp: isSet(object.memcmp)
                ? exports.SubscribeRequestFilterAccountsFilterMemcmp.fromJSON(object.memcmp)
                : undefined,
...
exports.SubscribeUpdate = {
    ...
    fromJSON: function (object) {
        return {
            filters: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.filters)
                ? object.filters.map(function (e) { return globalThis.String(e); })
                : [],
            account: isSet(object.account)
                ? exports.SubscribeUpdateAccount.fromJSON(object.account)
                : undefined,
            slot: isSet(object.slot)
                ? exports.SubscribeUpdateSlot.fromJSON(object.slot)
                : undefined,
            transaction: isSet(object.transaction)
                ? exports.SubscribeUpdateTransaction.fromJSON(object.transaction)
                : undefined,
            block: isSet(object.block)
                ? exports.SubscribeUpdateBlock.fromJSON(object.block)
                : undefined,
            ping: isSet(object.ping)
                ? exports.SubscribeUpdatePing.fromJSON(object.ping)
                : undefined,
            pong: isSet(object.pong)
                ? exports.SubscribeUpdatePong.fromJSON(object.pong)
                : undefined,
            blockMeta: isSet(object.blockMeta)
                ? exports.SubscribeUpdateBlockMeta.fromJSON(object.blockMeta)
                : undefined,
            entry: isSet(object.entry)
                ? exports.SubscribeUpdateEntry.fromJSON(object.entry)
                : undefined
        };
    },
    toJSON: function (message) {
...
exports.SubscribeUpdateAccount = {
    ...
    fromJSON: function (object) {
        return {
            account: isSet(object.account)
                ? exports.SubscribeUpdateAccountInfo.fromJSON(object.account)
                : undefined,
...
exports.SubscribeUpdateTransaction = {
    ...
    fromJSON: function (object) {
        return {
            transaction: isSet(object.transaction)
                ? exports.SubscribeUpdateTransactionInfo.fromJSON(object.transaction)
                : undefined,
            slot: isSet(object.slot) ? globalThis.String(object.slot) : "0"
        };
    },
...
exports.SubscribeUpdateTransactionInfo = {
    ...
    fromJSON: function (object) {
        return {
            ...
            transaction: isSet(object.transaction)
                ? solana_storage_1.Transaction.fromJSON(object.transaction)
                : undefined,
            meta: isSet(object.meta)
                ? solana_storage_1.TransactionStatusMeta.fromJSON(object.meta)
                : undefined,
...
exports.SubscribeUpdateBlock = {
    ...
    fromJSON: function (object) {
        return {
            ...
            rewards: isSet(object.rewards)
                ? solana_storage_1.Rewards.fromJSON(object.rewards)
                : undefined,
            ...
            transactions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.transactions)
                ? object.transactions.map(function (e) {
                    return exports.SubscribeUpdateTransactionInfo.fromJSON(e);
                })
                : [],
            ...
            accounts: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.accounts)
                ? object.accounts.map(function (e) {
                    return exports.SubscribeUpdateAccountInfo.fromJSON(e);
                })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.transactions) === null || _a === void 0 ? void 0 : _a.length) {
            obj.transactions = message.transactions.map(function (e) {
                return exports.SubscribeUpdateTransactionInfo.toJSON(e);
            });
        }
        if (message.updatedAccountCount !== "0") {
        ...
        if ((_b = message.accounts) === null || _b === void 0 ? void 0 : _b.length) {
            obj.accounts = message.accounts.map(function (e) {
                return exports.SubscribeUpdateAccountInfo.toJSON(e);
            });
        }
        if (message.entriesCount !== "0") {
    ...
    fromPartial: function (object) {
        ...
        message.transactions =
            ((_f = object.transactions) === null || _f === void 0 ? void 0 : _f.map(function (e) {
                return exports.SubscribeUpdateTransactionInfo.fromPartial(e);
            })) || [];
        message.updatedAccountCount = (_g = object.updatedAccountCount) !== null && _g !== void 0 ? _g : "0";
        message.accounts =
            ((_h = object.accounts) === null || _h === void 0 ? void 0 : _h.map(function (e) { return exports.SubscribeUpdateAccountInfo.fromPartial(e); })) ||
                [];
        message.entriesCount = (_j = object.entriesCount) !== null && _j !== void 0 ? _j : "0";
        message.entries =
            ((_k = object.entries) === null || _k === void 0 ? void 0 : _k.map(function (e) { return exports.SubscribeUpdateEntry.fromPartial(e); })) || [];
        return message;
    }
};
...
exports.GeyserService = {
    subscribe: {
        ...
        requestSerialize: function (value) {
            return Buffer.from(exports.SubscribeRequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.SubscribeRequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.SubscribeUpdate.encode(value).finish());
        },
    ...
    ping: {
        ...
        requestSerialize: function (value) {
            return Buffer.from(exports.PingRequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.PingRequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.PongResponse.encode(value).finish());
        },
    ...
    getLatestBlockhash: {
        ...
        requestDeserialize: function (value) {
            return exports.GetLatestBlockhashRequest.decode(value);
        },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetLatestBlockhashResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.GetLatestBlockhashResponse.decode(value);
        }
    },
    getBlockHeight: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.GetBlockHeightRequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.GetBlockHeightRequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetBlockHeightResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.GetBlockHeightResponse.decode(value);
        }
    },
    getSlot: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.GetSlotRequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.GetSlotRequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetSlotResponse.encode(value).finish());
        },
    ...
    isBlockhashValid: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.IsBlockhashValidRequest.encode(value).finish());
        },
        requestDeserialize: function (value) {
            return exports.IsBlockhashValidRequest.decode(value);
        },
        responseSerialize: function (value) {
            return Buffer.from(exports.IsBlockhashValidResponse.encode(value).finish());
        },
        responseDeserialize: function (value) {
            return exports.IsBlockhashValidResponse.decode(value);
        }
    },
    getVersion: {
        ...
        responseStream: false,
        requestSerialize: function (value) {
            return Buffer.from(exports.GetVersionRequest.encode(value).finish());
        },
        requestDeserialize: function (value) { return exports.GetVersionRequest.decode(value); },
        responseSerialize: function (value) {
            return Buffer.from(exports.GetVersionResponse.encode(value).finish());
        },
